...
public class MQConstants {
     ...
     * MQ queue name.
     */
    public static final String QUEUE_NAME_PROPERTY = "rmq.sender.queue";
     ...
     */
    public static final String MQ_SERVER_PROTO = "rmq.server.protocol";

    /**
     * Represents rabbit mq server user name.
     */
    public static final String MQ_SERVER_UNAME = "rmq.server.username";

    /**
     * Represents rabbit mq server password.
     */
    public static final String MQ_SERVER_PWD = "rmq.server.password";

    /**
     * Represents rabbit mq server address.
     */
    public static final String MQ_SERVER_ADDR = "rmq.server.ip.address";

    /**
     * Represents rabbit mq server port.
     */
    public static final String MQ_SERVER_PORT = "rmq.server.port";

    /**
     * Represents rabbit mq server vhost.
     */
    public static final String MQ_SERVER_VHOST = "rmq.server.vhost";
